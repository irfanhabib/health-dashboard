...
export class InfluxDBHandler {
    ...
    getBaseQuery = (metric, time, timeDuration = '1h') => `${this.baseQuery}&q=SELECT%20mean(%22value%22)%20FROM%20%22${metric}%22%20WHERE%20time%20%3E%3D%20${time}ms%20GROUP%20BY%20time(${timeDuration})%20fill(null)&epoch=ms`;
